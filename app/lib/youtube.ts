export const getYoutubeTopic = (topicId: string) => {
    return YOUTUBE_TOPICS[YOUTUBE_TOPICS.findIndex(({id}) => id === topicId)].kr
}

export const getCountryName = (code: any) => {
    return COUNTRY_CODES[code]?.CountryNameKR;

}


const YOUTUBE_TOPICS = [
    { id: "/m/04rlf", topic: "Music", parent: true, kr: "음악"},
    ...
    { id: "/m/019_rr", topic: "Lifestyle", parent: true, kr: "라이프 스타일" },
    { id: "/m/032tl", topic: "Fashion", kr: "패션"},
    { id: "/m/027x7n", topic: "Fitness", kr: "운동"},
    { id: "/m/02wbm", topic: "Food", kr: "음식"},
